...
public class Configuration {
    public static final String URL_SIGNUP= "http://192.168.1.18/Android/kiddo/signup.php";
    public static final String URL_LOGIN= "http://192.168.1.18/Android/kiddo/login.php";
    ...
    public static final String KEY_MAIN_ACT_SUBTITLE = "subtitle";
    public static final String KEY_CREATED_BY = "created_by";
    public static final String KEY_CREATED_FOR = "created_for";
}
